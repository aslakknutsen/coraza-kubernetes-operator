...
func TestMultiEngineMultiGateway(t *testing.T) {
	...
	t.Run("engine_per_gateway_shared_ruleset", func(t *testing.T) {
		...
		s.CreateRuleSet(ns, "shared-rules", []framework.RuleRef{
			{APIVersion: "v1", Kind: "ConfigMap", Name: "base-rules"},
			{APIVersion: "v1", Kind: "ConfigMap", Name: "block-rules"},
		})
	...
	t.Run("multiple_engines_single_gateway", func(t *testing.T) {
		...
		s.CreateRuleSet(ns, "ruleset-a", []framework.RuleRef{
			{APIVersion: "v1", Kind: "ConfigMap", Name: "base-rules"},
			{APIVersion: "v1", Kind: "ConfigMap", Name: "rules-a"},
		})
		s.CreateRuleSet(ns, "ruleset-b", []framework.RuleRef{
			{APIVersion: "v1", Kind: "ConfigMap", Name: "base-rules"},
			{APIVersion: "v1", Kind: "ConfigMap", Name: "rules-b"},
		})
