...
`)
	...
	s.CreateRuleSet(ns, "crs-ruleset", []framework.RuleRef{
		{APIVersion: "v1", Kind: "ConfigMap", Name: "base-rules"},
		{APIVersion: "v1", Kind: "ConfigMap", Name: "sqli-rules"},
		{APIVersion: "v1", Kind: "ConfigMap", Name: "xss-rules"},
	})
	...
	gw.ExpectStatus("/?id=1'+OR+'1'='1", http.StatusForbidden)
